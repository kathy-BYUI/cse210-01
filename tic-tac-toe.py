...
board_color = "\x1b[1;33m"
player_color = "\033[1;36m"
message_color = "\033[;35m"
turn_color = "\033[;31m"
endgame_color = "\x1b[1;33m"
...
def draw_board(board):
    ...
    #print('   |   |')
    print(board_color+' ' + board[1] + ' | ' + board[2] + ' | ' + board[3])
    #print('   |   |')
    print(board_color+'---+---+---')
    #print('   |   |')
    print(board_color+' ' + board[4] + ' | ' + board[5] + ' | ' + board[6])
    #print('   |   |')
    print(board_color+'---+---+---')
    #print('   |   |')
    print(board_color+' ' + board[7] + ' | ' + board[8] + ' | ' + board[9])
    #print('   |   |')
...
def input_player_letter():
    ...
    while not (letter == 'X' or letter == 'O'):
        print(player_color+'Do you want to be X or O?')
        letter = input().upper()

    # the first element in the tuple is the player's letter, the second is
    # the computer's letter.
    if letter == 'X':
        print(player_color+f"YOU are '{letter}'. COMPUTER is 'O'")
        return ['X', 'O']
    else:
        print(player_color+f"YOU are '{letter}'. COMPUTER is 'X'")
        return ['O', 'X']
...
def play_again():
    ...
    # it returns False.
    print(player_color+'Do you want to play again? (yes or no)')
...
def get_player_move(board):
    ...
    while move not in '1 2 3 4 5 6 7 8 9'.split() or not is_space_free(board, int(move)):
        print(turn_color+'What is your next move? (1-9)')
        move = input()
    return int(move)
        ...
        while game_is_playing:
            if turn == 'YOU':
                ...
                if is_winner(the_board, player_letter):
                    draw_board(the_board)
                    print(endgame_color+'Hooray! You have won the game!')
                    game_is_playing = False
                else:
                    if is_board_full(the_board):
                        draw_board(the_board)
                        print(endgame_color+'The game is a tie!')
                        break
                    else:
                        turn = 'COMPUTER'
                ...
                if is_winner(the_board, computer_letter):
                    draw_board(the_board)
                    print(endgame_color+'The computer has won!')
                    game_is_playing = False
                else:
                    if is_board_full(the_board):
                        draw_board(the_board)
